      ...
      <div class="dark-card w-full max-w-2xl mx-4 fade-up"
        ...
        <div class="p-6 flex flex-col gap-5">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="dark-card p-5" style="border-color:#333">
              <p class="text-sm mb-2" style="color:var(--muted)">Avg Heart Rate (bpm)</p>
          ...
          <div class="dark-card p-5" style="border-color:#333">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
              ...
              <input id="workout-heartRate" type="number" min="0" max="250"
                     class="fit-input" placeholder="Avg heart rate in bpm (optional)" />
